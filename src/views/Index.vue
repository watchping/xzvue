          ...
          <div id="p1" class="col-md-7">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              <div class="card-body d-flex flex-column align-items-start">
                ...
                <router-link class="btn btn-primary" :to="`/product/detail/${p1.href.split('=')[1]}`"    
                  >查看详情</router-link
                >
              </div>
              <img
          ...
          <div id="p2" class="col-md-5 pl-0">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              <div class="card-body d-flex flex-column align-items-start">
                ...
                <router-link class="btn btn-primary" :to="`/product/detail/${p2.href.split('=')[1]}`"
                  >查看详情</router-link
                >
              </div>
              <img
          ...
          <div id="p3" class="col-md-5">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              <div class="card-body d-flex flex-column align-items-start">
                ...
                <span class="text-primary" v-cloak>{{p1.price.toFixed(2)}}</span>
                <router-link class="btn btn-primary" :to="`/product/detail/${p3.href.split('=')[1]}`"
                  >查看详情</router-link
                >
              </div>
              <img
            ...
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              <div class="card-body d-flex flex-column align-items-start">
                ...
                <h6 class="mb-5">
                  <a class="text-dark" href="javascript:;"
                    >酷睿双核i5处理器|256GB
                    SSD|8GB内存|英特尔HD显卡620含共享显卡内存</a
                  >
                </h6>
                <span class="text-primary">¥6988.00</span>
                <a class="btn btn-primary" href="product_details.html?lid=1"
                  >查看详情</a
                >
              </div>
              <img
          ...
          <div class="col-md-5">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              <div class="card-body d-flex flex-column align-items-start">
                ...
                <h6 class="mb-5">
                  <a class="text-dark" href="javascript:;"
                    >酷睿双核i5处理器|512GB SSD|2GB内存|英特尔HD独立显卡</a
                  >
                </h6>
                <span class="text-primary">¥3488.00</span>
                <a class="btn btn-primary" href="product_details.html?lid=5"
                  >查看详情</a
                >
              </div>
              <img
          ...
          <div class="col-md-5">
            <div class="card border-0 flex-md-row box-shadow h-md-250">
              <div class="card-body d-flex flex-column align-items-start">
                ...
                <a class="btn btn-primary" href="product_details.html?lid=9"
                  >查看详情</a
                >
              </div>
              <img
...
export default {
  data() {
    return {
      p1:{price:0,href:""},//第1个商品
      p2:{price:0,href:""},//第2个商品
      p3:{price:0,href:""},//第3个商品
      others:[],//其余3个商品
    };
  },
  ...
  created() {
    this.axios.get("/index").then(res=>{
      ...
      this.p2 = p2;
      this.p3 = p3;
      this.others=res.data.recommendedItems.slice(3);

      //console.log(p1.href.split('='));
      console.log(p2.href.split('=')[1]);
